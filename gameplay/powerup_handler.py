...
def check_power_point_increment(combo_req: int | None, statistics: GameStatisticsData) -> bool:
    """Check if conditions are met to increment power points."""
...
def get_coords_for_random_reveal(
    ...
    """Determine a random subset of hidden coordinates to reveal."""
...
def get_coords_for_word_reveal(
    ...
    """Select the coordinates of a random, not-yet-guessed word."""
