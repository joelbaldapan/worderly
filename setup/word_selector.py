...
def generate_word_list(difficulty_conf: DifficultyData, lexicon_path: str) -> Tuple[Optional[str], Optional[List[str]]]:
    ...
    middle_word, list_of_words_to_place = find_valid_word_with_subwords(
        potential_middle_words, min_sub_len, min_words_needed, valid_subword_pool
    )
